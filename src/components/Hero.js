    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="text-center">
          ...
          >
            <span className="text-gradient">Vinayak Bhoj 👋</span>
          </motion.h1>
          ...
          >
            A passionate Full-Stack Developer and Computer Engineering student (2022–26). Currently focused on turning ideas into real-world projects that solve problems and create impact.
          </motion.p>
